...
public:
    ...
    {
        inImgItem->setWindowTitle(QApplication::translate("InImgItem", "Form", nullptr));
        thumbnail->setText(QString());
        name->setText(QApplication::translate("InImgItem", "<html><head/><body><p><span style=\" font-size:26pt;\">%1</span></p></body></html>", nullptr));
        fileName->setText(QApplication::translate("InImgItem", "<html><head/><body><p><span style=\" font-size:16pt; font-style:italic;\">%1</span></p></body></html>", nullptr));
        resolution->setText(QApplication::translate("InImgItem", "<html><head/><body><p><span style=\" font-weight:600;\">%1</span></p></body></html>", nullptr));
    } // retranslateUi
